...
|---|---:|---:|---:|---:|---:|---:|---:|
| pdf_tapping_simultaneous_rhythm_lead | OK | OK | OK | OK | OK | OK | 0.52s |
| pdf_facgce_open_string_voicing | OK | OK | OK | OK | OK | OK | 0.07s |
| pdf_clean_maj9_ambient_texture | OK | OK | OK | OK | OK | OK | 0.05s |
...
- 耗时：total=0.52s，text=0.08s，visual=0.09s，kg=0.36s
...
- 期望视觉：n/a
- 结果：文本R@5=OK，视觉R@5=OK，KG=OK，Bundle=OK
- 耗时：total=0.07s，text=0.01s，visual=0.01s，kg=0.05s
- 缓存：text_embedding=OK，visual_embedding=OK

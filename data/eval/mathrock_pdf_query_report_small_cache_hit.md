...
|---|---:|---:|---:|---:|---:|---:|---:|
| pdf_tapping_simultaneous_rhythm_lead | MISS | OK | OK | OK | OK | OK | 0.47s |
| pdf_facgce_open_string_voicing | OK | OK | OK | OK | OK | OK | 0.05s |
| pdf_clean_maj9_ambient_texture | MISS | MISS | OK | OK | OK | MISS | 0.04s |
...
- 耗时：total=0.47s，text=0.06s，visual=0.09s，kg=0.32s

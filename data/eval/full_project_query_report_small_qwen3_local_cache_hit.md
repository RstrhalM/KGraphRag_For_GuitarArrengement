...
|---|---:|---:|---:|---:|---:|---:|---:|
| whole_funk_muted_chuck_space | OK | OK | n/a | n/a | OK | OK | 0.42s |
| whole_mathrock_open_string_tapping | OK | OK | OK | OK | OK | OK | 0.14s |
| whole_fretboard_triad_arpeggio | OK | OK | OK | OK | OK | OK | 0.06s |
| whole_arrangement_diagnosis_muddy_dense | OK | OK | n/a | n/a | OK | OK | 0.04s |
...
- 耗时：total=0.42s，text=0.06s，visual=n/a，kg=0.36s
...
- 耗时：total=0.14s，text=0.01s，visual=0.09s，kg=0.04s
...
- 结果：文本R@5=OK，视觉R@5=OK，KG=OK，Bundle=OK
- 耗时：total=0.06s，text=0.01s，visual=0.01s，kg=0.04s
- 缓存：text_embedding=OK，visual_embedding=OK
